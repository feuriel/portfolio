...
export const Navbar = () => {
  ...
  return (
    <nav className="navbar fixed left-0 right-0 m-auto top-0 z-50 w-full max-w-7xl px-4 md:px-12 xl:px-4 py-2 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
