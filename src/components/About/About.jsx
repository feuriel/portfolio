...
export const About = () => {
  return (
    <section id="about" className="flex justify-center items-center">
      <section className="w-full about max-w-7xl min-h-dvh px-4 md:px-12 xl:px-4">
        <div>
          <h3>Hi there! I'm Gabriel !</h3>
          <p>
            I am a <em>tech lead and team catalyst</em> who wears many hats -
            and loves every one of them. At heart, I'm a leader who believes
            great software emerges when teams feel empowered, connected, and
            inspired. My superpower is
          ...
          <ul>
            <li>
              🤝 People-first - Cultivating teams where engineers thrive, not
              just deliver
            </li>
            <li>
            ...
            <li>
              🧠 Continuous learning - Exploring how AI can elevate both
              products and teams
            </li>
          </ul>
